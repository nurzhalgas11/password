...
public class Generator {
    ...
    public Generator(boolean IncludeUpper,boolean IncludeLow,boolean IncludeNum,boolean IncludeSym){
        alphabet=new Alphabet(IncludeUpper,IncludeLow,IncludeNum,IncludeSym);
    }
